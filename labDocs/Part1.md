...
Use your preferred text editor to make adjustments to both files. We will be
updating `azuredeploy.local.json` to allow for fewer Master nodes. This is due
to the default 10-core constraint in the Azure Pass Subscription. The bulk of our editing work will be
